...
def run():
    ...
    if menu == "Dashboard":
        ...
        with col1:
            if category_data and len(category_data) > 0:
                ...
                fig = px.pie(df_cat, names="Category", values="Total Spent", hole=0.3, title="Category Breakdown")
        ...
        with col2:
            if trend_data and len(trend_data) > 0:
                ...
                fig = px.bar(df_trend, x="Month", y="Total Spent", title="Monthly Spending Trend")
                st.plotly_chart(fig, use_container_width=True)
            else:
    ...
    # ------------------- 3. Future Payments ------------------- #
        ...
        if not reminders_df.empty:
            ...
            st.info("No upcoming payments. Add one below.")
